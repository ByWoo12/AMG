...
exports.run = (client, message, args) => {
  let prefix = db.fetch(`prefix_${message.guild.id}`) || client.ayarlar.prefix || "!"//! yerine kendi prefixini yaz!
...
message.channel.send(basarili)
    ...
    if (!efemm) return message.channel.send("Olamaz! yanlış bir biçimde kullandın. Örnek kullanım: " + prefix +"otocevap ekle <beklenecekmesaj> | <cevap>")
...
Eğer ${prefix}${message.content.split(" ")[0].slice(client.ayarlar.prefix.length)}'dan sonra
